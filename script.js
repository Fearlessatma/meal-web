                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${element.idMeal})">see more</button>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block">No items</span>
                            <div class="mb-4 lead">
                                search other food
                            </div>
                        </div>
        ...
        html += `
          <div id="meal-details" class="mb-5">
            ...
            <div class="text-center">
              <a href="index.html" target="_blank" class="btn btn-outline-light mt-3">back</a>
            </div>
          </div>
        `;
    });
            ...
            await fetchMealsFromApi(url, arr[index]).then((data) => {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" id="details-btn" class="btn btn-outline-light" onclick="showMealDetails(${data.meals[0].idMeal})">see more</button>
